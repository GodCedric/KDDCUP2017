...
# 平均时间
# 选择特征
X_time = X_time.drop(['route', 'intersection_id', 'tollgate_id', 'time_window', 'start_time', 'date', 'time'], axis=1)
...
X_time = X_time.drop(['hour', 'minute', 'weekday', 'is_workday'], axis=1)

val_X_time = val_X_time.drop(['route', 'intersection_id', 'tollgate_id', 'time_window', 'start_time', 'date', 'time'], axis=1)
...
val_X_time = val_X_time.drop(['hour', 'minute', 'weekday', 'is_workday'], axis=1)

# 测试集同步
travel_time_submission = travel_time_test_data[['intersection_id', 'tollgate_id', 'time_window']]
travel_time_test_data = travel_time_test_data.drop(['route', 'intersection_id', 'tollgate_id', 'time_window', 'start_time', 'date', 'time'], axis=1)
...
travel_time_test_data = travel_time_test_data.drop(['hour', 'minute', 'weekday', 'is_workday'], axis=1)

# 流量
# 选择特征
X_volume = X_volume.drop(['pair', 'tollgate_id', 'direction', 'time_window', 'start_time', 'date', 'time'], axis=1)
...
X_volume = X_volume.drop(['hour', 'minute', 'weekday', 'is_workday'], axis=1)

val_X_volume = val_X_volume.drop(['pair', 'tollgate_id', 'direction', 'time_window', 'start_time', 'date', 'time'], axis=1)
...
val_X_volume = val_X_volume.drop(['hour', 'minute', 'weekday', 'is_workday'], axis=1)

# 测试集同步
volume_submission = volume_test_data[['tollgate_id', 'time_window', 'direction']]
volume_test_data = volume_test_data.drop(['pair', 'tollgate_id', 'direction', 'time_window', 'start_time', 'date', 'time'], axis=1)
...
volume_test_data = volume_test_data.drop(['hour', 'minute', 'weekday', 'is_workday'], axis=1)
