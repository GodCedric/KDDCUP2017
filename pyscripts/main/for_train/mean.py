...
# 读取前两小时的数据
travel_time_before2hour = pd.read_csv('/home/godcedric/GitLocal/KDDCUP2017/待加工数据集/初始形成时间窗的数据集/test1_20min_avg_travel_time.csv')
volume_before2hour = pd.read_csv('/home/godcedric/GitLocal/KDDCUP2017/待加工数据集/初始形成时间窗的数据集/test1_20min_avg_volume.csv')
...
travel_time_submission.to_csv('/home/godcedric/GitLocal/KDDCUP2017/submission_result/phase1.5/mean1.5/2小时修正_系数/travel_time_submission.csv', index=False)
volume_submission.to_csv('/home/godcedric/GitLocal/KDDCUP2017/submission_result/phase1.5/mean1.5/2小时修正_系数/volume_submission.csv', index=False)